...
type
  ...
  TPkgJsonMapper = class
    ...
    public
      constructor Create(ATreeView: TTreeView = nil);
      destructor  Destroy; override;
...
begin
  ...
  try
    ...
    LList.Add('');
    LList.Add('//  *************************************************');
    LList.Add('//    Generated By: JsonToDelphiClass ');
    LList.Add('//    Project link original: https://github.com/PKGeorgiev/Delphi-JsonToDelphiClass');
    ...
    LList.Add('//  *************************************************');
    LList.Add('//    Updated By           : Janailson Rocha - 2021');
    LList.Add('//    WebSite              : ');
    LList.Add('//  *************************************************');
    LList.Add('');
    LList.Add('interface');
    LList.Add('');
    LList.Add('uses Generics.Collections, Rest.Json, Classes;');
    LList.Add('');
    LList.Add('type');
...
begin
  ...
  try
    LLines.Add('');
    LLines.Add(FName + ' = class(TPersistent)');
    LLines.Add('private');
